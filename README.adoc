...
. Fork link:https://github.com/rjain-pivotal/pcf-workspace-devops/[`PCF Workspace for DevOps`]  
. Review the link:https://github.com/rjain-pivotal/pcf-workspace-devops/tree/master[overview] of the `cities` repository.  
