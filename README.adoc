...
For more information refer to link:Spring-Cloud.adoc[this document] on Spring Cloud configuration files
...
. First deploy the blue v1of the app.
[source,bash]
...
. Next, increment the BUILD_NUMBER in the env file and source it.
