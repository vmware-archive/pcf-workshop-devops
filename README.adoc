...
. Build the app +
cf-drivers-node is a Node app, download the dependencies of the Nodejs / AngularJS app +
+
[source,bash]
----
$ cd cf-drivers-node
...
* Be sure to name your application '<first-initial><last-initial>-drivers-node-ui'
...
[NOTE]
====
* Discussion on how do you do Continous Deployment and Delivery without zero downtime today.
====
